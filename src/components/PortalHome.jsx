...
import { Plane, ShieldCheck, ArrowRight, UserCircle, Calendar, Navigation2 } from 'lucide-react';
        ...
        <div className="container" style={{
            ...
            <div style={{
                ...
                >
                    ...
                    <h2 style={{ marginBottom: '12px', fontSize: '1.75rem', fontWeight: '700' }}>Agenda de Frota</h2>
                ...
                >
                    ...
                    <h2 style={{ marginBottom: '12px', fontSize: '1.75rem', fontWeight: '700' }}>Área do Cliente</h2>
                    <p style={{ color: '#94a3b8', marginBottom: '28px', fontSize: '1rem', lineHeight: '1.5' }}>
                ...
                >
                    ...
                    <h2 style={{ marginBottom: '12px', fontSize: '1.75rem', fontWeight: '700' }}>Painel Coordenador</h2>
                    <p style={{ color: '#94a3b8', marginBottom: '28px', fontSize: '1rem', lineHeight: '1.5' }}>
                ...
                >
                    ...
                    <h2 style={{ marginBottom: '12px', fontSize: '1.75rem', fontWeight: '700' }}>Cockpit Operacional</h2>
                    <p style={{ color: '#94a3b8', marginBottom: '28px', fontSize: '1rem', lineHeight: '1.5' }}>
